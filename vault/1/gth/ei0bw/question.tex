...
\begin{parts}
  \part[2] What will the $B^{+}$ tree look like after inserting $\mathbf{\vbone, \vbtwo}$ and $\mathbf\vbthree$ - in that order?
...
\begin{solution}[\halfpage]
  ...
  \part[2] If $\mathbf{\vbfive}$ and $\mathbf{\vbfour}$ are now removed from the tree - in that order - 
