...
\begin{parts}
  \ifprintanswers
    ...
    \end{marginfigure}
  \fi 
  \part[3] $\ldots$ English or Maths or both - but not Science?
\begin{solution}[\halfpage]
  ...
  \ifprintanswers
    ...
    \end{marginfigure}
  \fi 
  \part[1] $\ldots$ Maths and Science - but not English?
...
\begin{solution}[\mcq]
  ...
  \ifprintanswers
    ...
    \end{marginfigure}
  \fi 
  \part[3] $\ldots$ in more than one subject? 
...
\ifprintanswers
  \begin{codex}
      $(a)\,\prta\quad (b)\,\prtb\quad (c)\,\prtc\quad (d)\,\prtd$
  \end{codex}
\fi
