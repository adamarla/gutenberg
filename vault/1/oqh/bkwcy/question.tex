...
\begin{parts}
  \part Find $\log_{10} N$ ($\log_{10}\vbone=\vbsix,\,\log_{10}\vbthree=\vbseven$)
  ...
  \part How many digits would there be in an \textbf{integer} M that lies between $10^{k}$ and $10^{k+1},\,k\in\mathbb{N}$? Your answer should be in terms of $k$
  ...
  \part Using your answers for part (a) and (b), how many digits do you think there are in  $\p^{\vbfive}$? 
