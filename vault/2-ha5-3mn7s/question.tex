...
\begin{parts}
  \part Show that $\dydx = \dfrac{3x^2y-y^2}{2xy-x^3}$.
  ...
  \part Find all the points on the curve whose \textit{x-coordinate} is $1$ and 
  ...
  \part Find the \textit{x-coordinate} of each point on the curve where the tangent
  line is vertical.
  \begin{solution}
