...
\begin{parts}
  \part Estimate $f'\left(4\right)$. Show the work that leads to your answer.
  \insertQR{}
  \begin{solution}
  ...
  \part Evaluate $\int_2^{13} \left(3-5f'\left(x\right)\right) \ud x$. Show the work that leads to your answer.
  \insertQR{}
  \begin{solution}
    \begin{align}
  ...
  \part Use a left Riemann sum with subintervals indicated by the data in the table to approximate $\int_2^{13} f\left(x\right) \ud x$. Show the work that leads to your answer.
  \insertQR{}
  \begin{solution}
  ...
  \part Suppose $f'\left(5\right) = 3$ and $f''\left(x\right) \leq 0$ for all $x$ in the closed interval $5 \leq x \leq 8$. Use the line tangent to the graph of $f$ at $x=5$ to show that $f\left(7\right) \leq 4$. Use the secant line for the graph of $f$ on $5 \leq x \leq 8$ to show that $f\left(7\right) \geq \dfrac{4}{3}$.
  \insertQR{}
  \ifprintanswers
    % stuff to be shown only in the answer key - like explanatory margin figures
