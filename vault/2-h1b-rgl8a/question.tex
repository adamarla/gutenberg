...
\begin{parts}
  ...
  \part For $-4 < x < 4$, find all values of $x$ at which the graph of $f$ has a point of inflection. Justify your answer.
  \begin{solution}
  ...
  \begin{solution}
    ...
    \end{align}
  \end{solution}
  \part For $-4 \leq x \leq 4$, find the value of $x$ at which $f$ has an absolute maximum. Justify your answer.
  \begin{solution}
