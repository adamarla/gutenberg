...
\question[3] Find the distance of the point $(\vbone, \vbtwo)$ from the line $\vbthree x + \vbfour y = \vbfive$ measured parallel to the line $\vbsix x \vbseven y + \vbeight = 0$.
