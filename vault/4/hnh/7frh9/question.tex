...
\question The sum of coefficients of first three terms of the expansion $\left( x- \dfrac{\vbone}{x^{2}} \right) ^{m} (m \in \mathbb{N})$ is $\vbtwo$. Find the term of expansion containing $x^{\vbfour}$.
