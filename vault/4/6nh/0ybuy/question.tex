...
\gcalcexpr[0]\m {(\vbone - \n)/2}  
\gcalcexpr[0]\o {\m+\n}
\question If the sum of third and eighth term of an Arithmetic progression is $\vbone$. And the sum of seventh and fourteenth term is $\vbtwo$. Find the tenth term. 
