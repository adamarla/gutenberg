...
\begin{parts}
  \part[2] At the time when the radius of the sphere is 10 centimetres, what is 
...
\begin{solution}[\halfpage]
  ...
  \part[2] At the time when the volume of the sphere is $36\pi$ cubic centimetres,
...
\nextpg
  \part[2] At the time when the volume and the radius of the sphere are increasing 
