...
\begin{parts}
  \part At the time when the radius of the sphere is 10 centimetres, what is 
  ...
  \part At the time when the volume of the sphere is $36\pi$ cubic centimetres,
  ...
  \part At the time when the volume and the radius of the sphere are increasing 
