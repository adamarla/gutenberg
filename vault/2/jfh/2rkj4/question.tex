...
\begin{solution}[\mcq]
  ...
  \part[2] Find the $x$-coordinate of each point of inflection of the graph of $y=g(x)$ on the interval
...
\begin{solution}[\mcq]
  ...
  \part[4] The function $h$ is defined by $h(x)=g(x)-\frac{1}{2}x^2$. Find the $x$-coordinate of each 
...
\begin{solution}[\halfpage]
    ...
    \begin{align}
      g'(x)=\sqrt{4-x^2}=x \implies x=\sqrt{2}
    \end{align}
...
\ifprintanswers\begin{codex}
  (a) $5-pi$ (b) $x=2$, $x=3$ \\
  (c) $x=\sqrt{2}$ (max), $x=3$ (neither max nor min)
\end{codex}\fi
