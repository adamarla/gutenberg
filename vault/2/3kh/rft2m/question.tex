...
\begin{parts}
  \part[1] Write an SQL query that computes for every person the total number of
...
\begin{solution}[\mcq]
  ...
  \part[1] A cool person is one that has at least $40$ friends. Write an SQL query 
