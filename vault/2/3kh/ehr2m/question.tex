...
\begin{parts}
  \part[1] Is there a weak entity type in this schema? If yes, then show
...
\begin{solution}[\mcq]
  ...
  \part[1] Is there a partial participation constraint in the schema? If
...
\begin{solution}[\mcq]
  ...
  \part[1] Is there a total participation constraint in the schema? If there
