...
\question If the letters of the word $\vbone$ are permutated and all the
...
\begin{solution}
  ...
  \begin{align}
    \text{Number of words not beginning with $\vbfive$} &= 3\times4! \\
    													&= 72
  \end{align}
