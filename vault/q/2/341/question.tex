...
\begin{solution}[\mcq]
  ...
  explain why the graph of $B$ cannot resemble the below graph.\\
%  \begin{marginfigure}
    \vspace{1cm}
    \figinit{pt}
      \figpt 100:(-5,0)
...
\begin{solution}[\halfpage]
    ...
    \begin{align}
      -\ln(100-20)=\dfrac{1}{5}(0)+C \implies -\ln(80) = C
    \end{align}
...
\ifprintanswers\begin{codex}
  (a) $40$gm (b) $\frac{d^2B}{dt^2}= -\frac{1}{25}(100-B)$ \\
  (c) $B(t) = 100 - 80 e^{-t/5}\text{,}\quad t\geq 0$
\end{codex}\fi
