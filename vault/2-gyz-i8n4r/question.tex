...
\question[3] Without using a calculator, find the value of the following expression:

$2\cdot\left( \dfrac{\cos\ang{58}}{\sin\ang{32}}\right) - 
\sqrt{3}\cdot\left( \dfrac{\cos\ang{32}\csc\ang{52}}{\tan\ang{15}\tan\ang{60}\tan\ang{75}}\right)$
\ifprintanswers
