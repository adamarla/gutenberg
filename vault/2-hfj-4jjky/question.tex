...
\begin{parts}
  \part Write an equation for the line tangent to the graph of $f$ at $x=\dfrac{1}{2}$.
  ...
  \part Write, but do not, an integral expression for the volume of the solid generated
