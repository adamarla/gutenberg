...
\begin{parts}
	\part Find the coordinates of the mid-points $X$, $Y$ and $Z$
	...
	\part Find the equations of the \textit{perpendicular} bisectors of the three sides of the triangle
	...
	\part Are the perpendicular bisectors concurrent? If yes, then find their point of intersection
