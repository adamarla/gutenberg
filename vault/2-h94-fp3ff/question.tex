...
\begin{parts}
  \part For what values of $x$ does $f$ have a relative maximum? Why?
  ...
  \part For what values of $x$ does $f$ have a relative minimum? Why?
  ...
  \part On what intervals is the graph of $f$ concave upwards. Use $f'$ to
  justify your answer.
  ...
  \part Suppose that $f(1)=0$. Draw a sketch that shows the general shape of the
  graph of the function $f$ on the open interval $0<x<2$.

  \insertQR{}
  \begin{solution}
    See adjacent figure. The first derivative of $f$ is negative but increasing
    from $0$ to $1$. This means $f$ is concave but with decreasing concavity. 
    Following this is a point of inflection at $x=1$ where $f'$ is zero after
    which it continues to be negative which means the slope of $f$ is still
    negative but this time it is decreasing due to which $f$ is decreasing at 
    an ever greater rate as $x$ increases.
  \end{solution}
