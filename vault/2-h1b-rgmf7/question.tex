...
\insertQR{}
	...
	\part[5] The region $R$ is the base of a solid. For this solid, at each $x$ the cross section perpendicular to the x-axis has an area $A(x)=\sin{\dfrac{\pi}{2}x}$. Find the volume of the solid.
\insertQR{}
	\begin{solution}[\halfpage]
	...
	\part[3] Another solid has the same base $R$. For this solid, the cross sections perpendicular to the y-axis are squares. Write. but do not evaluate, an integral expression for the volume of the solid.
\insertQR{}
\begin{solution}[\halfpage]
