...
\begin{solution}[\mcq]
	...
	\part[1] Another solid has the same base $R$. For this solid, the cross sections perpendicular to the y-axis are squares. Write. but do not evaluate, an integral expression for the volume of the solid.
\insertQR{QRC}
\begin{solution}[\mcq]
