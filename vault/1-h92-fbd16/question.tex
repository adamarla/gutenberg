...
\begin{parts}
  \part \vbtwo is \textit{never} included and none of the other characters can repeat? You might want to 
  ...
  \part \vbtwo is \textit{always} included \textit{but} none of the included characters repeat
  \insertQR{}
  \begin{solution}
  ...
  \part \vbtwo is \textit{never} included \textit{but} the other characters - if included - can repeat.
  ...
  \part \vbtwo is \textit{always} included \textit{and} the any of the included characters can repeat
