...
\begin{parts}
  \part Find the coordinates of the vertices of the triangle 
  ...
  \part Find the coordinates of the \textit{mid-points} of the sides of the triangle
  ...
  \part Find the \textit{circumcenter} of the triangle
